        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Aviliablefrom = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AviliableTill = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EcomCategory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EcomCategory_EcomCategory_ParentcategoryId",
                        column: x => x.ParentcategoryId,
                        principalTable: "EcomCategory",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AddressName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HubAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HubAddress_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleCategoryName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_EcomCategory_EcomCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModuleCatgoryId = table.Column<int>(type: "int", nullable: false),
                    ModuleCategoryId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyProfile_ModuleCategory_ModuleCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionProduct_Collection_CollectionsId",
                        column: x => x.CollectionsId,
                        principalTable: "Collection",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionProduct_Product_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductImages = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyRole = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariant_ProductImage_ProductImageId",
            ...
            migrationBuilder.CreateTable(
                name: "InventoryInventoryLocation",
                columns: table => new
                {
                    InventoriesId = table.Column<int>(type: "int", nullable: false),
                    InventoryLocationsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryInventoryLocation", x => new { x.InventoriesId, x.InventoryLocationsId });
                    table.ForeignKey(
                        name: "FK_InventoryInventoryLocation_Inventory_InventoriesId",
                        column: x => x.InventoriesId,
                        principalTable: "Inventory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryInventoryLocation_InventoryLocation_InventoryLocationsId",
                        column: x => x.InventoryLocationsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfile_ModuleCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyUser_CompanyProfileId",
                table: "CompanyUser",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EcomCategory_ParentcategoryId",
                table: "EcomCategory",
                column: "ParentcategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HubAddress_UserId1",
                table: "HubAddress",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryInventoryLocation_InventoryLocationsId",
                table: "InventoryInventoryLocation",
                column: "InventoryLocationsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_EcomCategoryId",
                table: "Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariant_ProductImageId",
                table: "ProductVariant",
